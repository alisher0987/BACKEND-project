...
const Customer_cardController = require("../Controller/customercardController");
 ...
 */
router.post("/customer_card", Customer_cardController.createCard);
 ...
 *         description: Server error
 */
router.get("/customer_card", Customer_cardController.getCards);
 ...
 *         description: Server error
 */
router.get("/customer_card/search", Customer_cardController.searchCards);
 ...
 *          description: Server error
 */
router.get("/customer_card/:id", Customer_cardController.getCardById);
 ...
 *         description: Server error
 */
router.put("/customer_card/:id", Customer_cardController.updateCard);
 ...
 *         description: Server error
 */
router.delete("/customer_card/:id", Customer_cardController.deleteCard);
