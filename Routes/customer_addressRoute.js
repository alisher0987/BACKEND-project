...
const Customer_addressController = require("../Controller/customeradressController");
 ...
 */
router.post("/customer_address", Customer_addressController.createAddress);
 ...
 *         description: Server error
 */
router.get("/customer_address", Customer_addressController.getAddresses);
 ...
 *         description: Server error
 */
router.get("/customer_address/search", Customer_addressController.searchAddresses);
 ...
 *          description: Server error
 */
router.get("/customer_address/:id", Customer_addressController.getAddressById);
 ...
 *         description: Server error
 */
router.put("/customer_address/:id", Customer_addressController.updateAddress);
 ...
 *         description: Server error
 */
router.delete("/customer_address/:id", Customer_addressController.deleteAddress);
